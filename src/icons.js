const iconBase = 'https://emojipedia-us.s3.amazonaws.com/thumbs/240/apple/';
const icons = {
  Japanese: {
  ...
  Jewish: {
    icon: iconBase + '118/flag-for-israel_1f1ee-1f1f1.png'
  },
  Filipino: {
    icon: iconBase + '118/flag-for-philippines_1f1f5-1f1ed.png'
  },
  Korean: {
  ...
  BBQ: {
    icon: iconBase + '118/meat-on-bone_1f356.png'
  },
  'Vegetarian / Vegan': {
